...
// Package assembled assembles the complete specification consumed by the rendering
// layer, combining the overlay-corrected explicit spec with the tgen-invented
// implicit types. It is the single entry point that rendering and the CLI
// should depend on.
package assembled
...
// Specification represents the fully assembled Telegram Bot API specification, combining
...
// specification.
func (s Specification) Explicit() explicit.Specification { return s.explicit }

// Implicit returns the set of tgen-defined types not present in the
// specification.
func (s Specification) Implicit() implicit.Spec { return s.implicit }
