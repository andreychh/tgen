...
class InputSticker(BaseModel):
    ...
    def form_json(self, payload: MultipartPayload) -> str:
        ...
        data["sticker"] = self.sticker.attach(payload)
...
class InputMediaAnimation(BaseModel):
    ...
    def form_json(self, payload: MultipartPayload) -> str:
        ...
        data["media"] = self.media.attach(payload)
        if self.thumbnail is not None:
            data["thumbnail"] = self.thumbnail.attach(payload)
        return json.dumps(data)
...
class InputMediaLivePhoto(BaseModel):
    ...
    def form_json(self, payload: MultipartPayload) -> str:
        ...
        data["media"] = self.media.attach(payload)
        data["photo"] = self.photo.attach(payload)
        return json.dumps(data)
...
class InputMediaVideo(BaseModel):
    ...
    def form_json(self, payload: MultipartPayload) -> str:
        ...
        if self.cover is not None:
            data["cover"] = self.cover.attach(payload)
        return json.dumps(data)
...
class InputProfilePhotoAnimated(BaseModel):
    ...
    def form_json(self, payload: MultipartPayload) -> str:
        ...
        data["animation"] = self.animation.attach(payload)
        return json.dumps(data)
...
class InputStoryContentVideo(BaseModel):
    ...
    def form_json(self, payload: MultipartPayload) -> str:
        ...
        data["video"] = self.video.attach(payload)
        return json.dumps(data)
