...
class GetUpdatesMethod(BaseModel):
    ...
    async def call(self, conn: Connection) -> list[Update]:
        ...
        if self.offset is not None:
            IntPart(self.offset).write(payload, "offset")
        if self.limit is not None:
            IntPart(self.limit).write(payload, "limit")
        if self.timeout is not None:
            IntPart(self.timeout).write(payload, "timeout")
        if self.allowed_updates is not None:
            ListPart(self.allowed_updates).write(payload, "allowed_updates")
...
class SetWebhookMethod(BaseModel):
    ...
    async def call(self, conn: Connection) -> bool:
        payload = MultipartPayload()
        StrPart(self.url).write(payload, "url")
        if self.certificate is not None:
            self.certificate.write(payload, "certificate")
        if self.ip_address is not None:
            StrPart(self.ip_address).write(payload, "ip_address")
        if self.max_connections is not None:
            IntPart(self.max_connections).write(payload, "max_connections")
        if self.allowed_updates is not None:
            ListPart(self.allowed_updates).write(payload, "allowed_updates")
        if self.drop_pending_updates is not None:
            BoolPart(self.drop_pending_updates).write(payload, "drop_pending_updates")
        if self.secret_token is not None:
            StrPart(self.secret_token).write(payload, "secret_token")
...
class SendMessageMethod(BaseModel):
    ...
    async def call(self, conn: Connection) -> Message:
        payload = MultipartPayload()
        self.chat_id.write(payload, "chat_id")
        StrPart(self.text).write(payload, "text")
        if self.business_connection_id is not None:
            StrPart(self.business_connection_id).write(payload, "business_connection_id")
        if self.message_thread_id is not None:
            IntPart(self.message_thread_id).write(payload, "message_thread_id")
        if self.direct_messages_topic_id is not None:
            IntPart(self.direct_messages_topic_id).write(payload, "direct_messages_topic_id")
        if self.parse_mode is not None:
            StrPart(self.parse_mode).write(payload, "parse_mode")
        if self.entities is not None:
            ListFormJsonPart(self.entities).write(payload, "entities")
        if self.link_preview_options is not None:
            self.link_preview_options.write(payload, "link_preview_options")
        if self.disable_notification is not None:
            BoolPart(self.disable_notification).write(payload, "disable_notification")
        if self.protect_content is not None:
            BoolPart(self.protect_content).write(payload, "protect_content")
        if self.allow_paid_broadcast is not None:
            BoolPart(self.allow_paid_broadcast).write(payload, "allow_paid_broadcast")
        if self.message_effect_id is not None:
            StrPart(self.message_effect_id).write(payload, "message_effect_id")
        if self.suggested_post_parameters is not None:
            self.suggested_post_parameters.write(payload, "suggested_post_parameters")
        if self.reply_parameters is not None:
            self.reply_parameters.write(payload, "reply_parameters")
        if self.reply_markup is not None:
            self.reply_markup.write(payload, "reply_markup")
...
class ForwardMessageMethod(BaseModel):
    ...
    async def call(self, conn: Connection) -> Message:
        payload = MultipartPayload()
        self.chat_id.write(payload, "chat_id")
        self.from_chat_id.write(payload, "from_chat_id")
        IntPart(self.message_id).write(payload, "message_id")
        if self.message_thread_id is not None:
            IntPart(self.message_thread_id).write(payload, "message_thread_id")
        if self.direct_messages_topic_id is not None:
            IntPart(self.direct_messages_topic_id).write(payload, "direct_messages_topic_id")
        if self.video_start_timestamp is not None:
            IntPart(self.video_start_timestamp).write(payload, "video_start_timestamp")
        if self.disable_notification is not None:
            BoolPart(self.disable_notification).write(payload, "disable_notification")
        if self.protect_content is not None:
            BoolPart(self.protect_content).write(payload, "protect_content")
...
class ForwardMessagesMethod(BaseModel):
    ...
    async def call(self, conn: Connection) -> list[MessageID]:
        ...
        self.chat_id.write(payload, "chat_id")
        self.from_chat_id.write(payload, "from_chat_id")
        ListPart(self.message_ids).write(payload, "message_ids")
        if self.message_thread_id is not None:
            IntPart(self.message_thread_id).write(payload, "message_thread_id")
        if self.direct_messages_topic_id is not None:
            IntPart(self.direct_messages_topic_id).write(payload, "direct_messages_topic_id")
...
class CopyMessageMethod(BaseModel):
    ...
    async def call(self, conn: Connection) -> MessageID:
        ...
        if self.caption is not None:
            StrPart(self.caption).write(payload, "caption")
        if self.parse_mode is not None:
            StrPart(self.parse_mode).write(payload, "parse_mode")
        if self.caption_entities is not None:
            ListFormJsonPart(self.caption_entities).write(payload, "caption_entities")
        if self.show_caption_above_media is not None:
            BoolPart(self.show_caption_above_media).write(payload, "show_caption_above_media")
        if self.disable_notification is not None:
            BoolPart(self.disable_notification).write(payload, "disable_notification")
        if self.protect_content is not None:
            BoolPart(self.protect_content).write(payload, "protect_content")
...
class CopyMessagesMethod(BaseModel):
    ...
    async def call(self, conn: Connection) -> list[MessageID]:
        ...
        if self.remove_caption is not None:
            BoolPart(self.remove_caption).write(payload, "remove_caption")
...
class SendPhotoMethod(BaseModel):
    ...
    async def call(self, conn: Connection) -> Message:
        payload = MultipartPayload()
        self.chat_id.write(payload, "chat_id")
        self.photo.write(payload, "photo")
        if self.business_connection_id is not None:
            StrPart(self.business_connection_id).write(payload, "business_connection_id")
        if self.message_thread_id is not None:
            IntPart(self.message_thread_id).write(payload, "message_thread_id")
        ...
        if self.has_spoiler is not None:
            BoolPart(self.has_spoiler).write(payload, "has_spoiler")
        if self.disable_notification is not None:
            BoolPart(self.disable_notification).write(payload, "disable_notification")
        if self.protect_content is not None:
            BoolPart(self.protect_content).write(payload, "protect_content")
...
class SendLivePhotoMethod(BaseModel):
    ...
    async def call(self, conn: Connection) -> Message:
        payload = MultipartPayload()
        self.chat_id.write(payload, "chat_id")
        self.live_photo.write(payload, "live_photo")
        self.photo.write(payload, "photo")
        if self.business_connection_id is not None:
            StrPart(self.business_connection_id).write(payload, "business_connection_id")
        if self.message_thread_id is not None:
...
class SendAudioMethod(BaseModel):
    ...
    async def call(self, conn: Connection) -> Message:
        payload = MultipartPayload()
        self.chat_id.write(payload, "chat_id")
        self.audio.write(payload, "audio")
        if self.business_connection_id is not None:
            StrPart(self.business_connection_id).write(payload, "business_connection_id")
        if self.message_thread_id is not None:
            IntPart(self.message_thread_id).write(payload, "message_thread_id")
        ...
        if self.duration is not None:
            IntPart(self.duration).write(payload, "duration")
        if self.performer is not None:
            StrPart(self.performer).write(payload, "performer")
        if self.title is not None:
            StrPart(self.title).write(payload, "title")
        if self.thumbnail is not None:
            self.thumbnail.write(payload, "thumbnail")
        if self.disable_notification is not None:
            BoolPart(self.disable_notification).write(payload, "disable_notification")
        if self.protect_content is not None:
            BoolPart(self.protect_content).write(payload, "protect_content")
...
class SendDocumentMethod(BaseModel):
    ...
    async def call(self, conn: Connection) -> Message:
        payload = MultipartPayload()
        self.chat_id.write(payload, "chat_id")
        self.document.write(payload, "document")
        if self.business_connection_id is not None:
            StrPart(self.business_connection_id).write(payload, "business_connection_id")
        if self.message_thread_id is not None:
            IntPart(self.message_thread_id).write(payload, "message_thread_id")
        ...
        if self.disable_content_type_detection is not None:
            BoolPart(self.disable_content_type_detection).write(payload, "disable_content_type_detection")
        if self.disable_notification is not None:
            BoolPart(self.disable_notification).write(payload, "disable_notification")
        if self.protect_content is not None:
            BoolPart(self.protect_content).write(payload, "protect_content")
...
class SendVideoMethod(BaseModel):
    ...
    async def call(self, conn: Connection) -> Message:
        payload = MultipartPayload()
        self.chat_id.write(payload, "chat_id")
        self.video.write(payload, "video")
        if self.business_connection_id is not None:
            StrPart(self.business_connection_id).write(payload, "business_connection_id")
        if self.message_thread_id is not None:
            IntPart(self.message_thread_id).write(payload, "message_thread_id")
        ...
        if self.width is not None:
            IntPart(self.width).write(payload, "width")
        if self.height is not None:
            IntPart(self.height).write(payload, "height")
        if self.thumbnail is not None:
            self.thumbnail.write(payload, "thumbnail")
        if self.cover is not None:
            self.cover.write(payload, "cover")
        if self.start_timestamp is not None:
            IntPart(self.start_timestamp).write(payload, "start_timestamp")
        if self.caption is not None:
            StrPart(self.caption).write(payload, "caption")
        if self.parse_mode is not None:
            StrPart(self.parse_mode).write(payload, "parse_mode")
        ...
        if self.supports_streaming is not None:
            BoolPart(self.supports_streaming).write(payload, "supports_streaming")
        if self.disable_notification is not None:
            BoolPart(self.disable_notification).write(payload, "disable_notification")
        if self.protect_content is not None:
            BoolPart(self.protect_content).write(payload, "protect_content")
...
class SendAnimationMethod(BaseModel):
    ...
    async def call(self, conn: Connection) -> Message:
        payload = MultipartPayload()
        self.chat_id.write(payload, "chat_id")
        self.animation.write(payload, "animation")
        if self.business_connection_id is not None:
            StrPart(self.business_connection_id).write(payload, "business_connection_id")
        if self.message_thread_id is not None:
            IntPart(self.message_thread_id).write(payload, "message_thread_id")
...
class SendVoiceMethod(BaseModel):
    ...
    async def call(self, conn: Connection) -> Message:
        payload = MultipartPayload()
        self.chat_id.write(payload, "chat_id")
        self.voice.write(payload, "voice")
        if self.business_connection_id is not None:
            StrPart(self.business_connection_id).write(payload, "business_connection_id")
        if self.message_thread_id is not None:
            IntPart(self.message_thread_id).write(payload, "message_thread_id")
...
class SendVideoNoteMethod(BaseModel):
    ...
    async def call(self, conn: Connection) -> Message:
        payload = MultipartPayload()
        self.chat_id.write(payload, "chat_id")
        self.video_note.write(payload, "video_note")
        if self.business_connection_id is not None:
            StrPart(self.business_connection_id).write(payload, "business_connection_id")
        if self.message_thread_id is not None:
            IntPart(self.message_thread_id).write(payload, "message_thread_id")
        ...
        if self.length is not None:
            IntPart(self.length).write(payload, "length")
        if self.thumbnail is not None:
            self.thumbnail.write(payload, "thumbnail")
        if self.disable_notification is not None:
            BoolPart(self.disable_notification).write(payload, "disable_notification")
...
class SendPaidMediaMethod(BaseModel):
    ...
    async def call(self, conn: Connection) -> Message:
        payload = MultipartPayload()
        self.chat_id.write(payload, "chat_id")
        IntPart(self.star_count).write(payload, "star_count")
        ListFormJsonPart(self.media).write(payload, "media")
        if self.business_connection_id is not None:
            StrPart(self.business_connection_id).write(payload, "business_connection_id")
        if self.message_thread_id is not None:
            IntPart(self.message_thread_id).write(payload, "message_thread_id")
        ...
        if self.payload is not None:
            StrPart(self.payload).write(payload, "payload")
        if self.caption is not None:
            StrPart(self.caption).write(payload, "caption")
        if self.parse_mode is not None:
            StrPart(self.parse_mode).write(payload, "parse_mode")
...
class SendLocationMethod(BaseModel):
    ...
    async def call(self, conn: Connection) -> Message:
        payload = MultipartPayload()
        self.chat_id.write(payload, "chat_id")
        FloatPart(self.latitude).write(payload, "latitude")
        FloatPart(self.longitude).write(payload, "longitude")
        if self.business_connection_id is not None:
            StrPart(self.business_connection_id).write(payload, "business_connection_id")
        if self.message_thread_id is not None:
            IntPart(self.message_thread_id).write(payload, "message_thread_id")
        ...
        if self.horizontal_accuracy is not None:
            FloatPart(self.horizontal_accuracy).write(payload, "horizontal_accuracy")
        if self.live_period is not None:
            IntPart(self.live_period).write(payload, "live_period")
        if self.heading is not None:
            IntPart(self.heading).write(payload, "heading")
        if self.proximity_alert_radius is not None:
            IntPart(self.proximity_alert_radius).write(payload, "proximity_alert_radius")
        if self.disable_notification is not None:
            BoolPart(self.disable_notification).write(payload, "disable_notification")
        if self.protect_content is not None:
            BoolPart(self.protect_content).write(payload, "protect_content")
...
class SendVenueMethod(BaseModel):
    ...
    async def call(self, conn: Connection) -> Message:
        ...
        FloatPart(self.longitude).write(payload, "longitude")
        StrPart(self.title).write(payload, "title")
        StrPart(self.address).write(payload, "address")
        if self.business_connection_id is not None:
            StrPart(self.business_connection_id).write(payload, "business_connection_id")
        if self.message_thread_id is not None:
            IntPart(self.message_thread_id).write(payload, "message_thread_id")
        ...
        if self.foursquare_id is not None:
            StrPart(self.foursquare_id).write(payload, "foursquare_id")
        if self.foursquare_type is not None:
            StrPart(self.foursquare_type).write(payload, "foursquare_type")
        if self.google_place_id is not None:
            StrPart(self.google_place_id).write(payload, "google_place_id")
        if self.google_place_type is not None:
            StrPart(self.google_place_type).write(payload, "google_place_type")
        if self.disable_notification is not None:
            BoolPart(self.disable_notification).write(payload, "disable_notification")
        if self.protect_content is not None:
            BoolPart(self.protect_content).write(payload, "protect_content")
...
class SendContactMethod(BaseModel):
    ...
    async def call(self, conn: Connection) -> Message:
        payload = MultipartPayload()
        self.chat_id.write(payload, "chat_id")
        StrPart(self.phone_number).write(payload, "phone_number")
        StrPart(self.first_name).write(payload, "first_name")
        if self.business_connection_id is not None:
            StrPart(self.business_connection_id).write(payload, "business_connection_id")
        if self.message_thread_id is not None:
            IntPart(self.message_thread_id).write(payload, "message_thread_id")
        ...
        if self.last_name is not None:
            StrPart(self.last_name).write(payload, "last_name")
        if self.vcard is not None:
            StrPart(self.vcard).write(payload, "vcard")
        if self.disable_notification is not None:
            BoolPart(self.disable_notification).write(payload, "disable_notification")
        if self.protect_content is not None:
            BoolPart(self.protect_content).write(payload, "protect_content")
...
class SendPollMethod(BaseModel):
    ...
    async def call(self, conn: Connection) -> Message:
        payload = MultipartPayload()
        self.chat_id.write(payload, "chat_id")
        StrPart(self.question).write(payload, "question")
        ListFormJsonPart(self.options).write(payload, "options")
        if self.business_connection_id is not None:
            StrPart(self.business_connection_id).write(payload, "business_connection_id")
        if self.message_thread_id is not None:
            IntPart(self.message_thread_id).write(payload, "message_thread_id")
        if self.question_parse_mode is not None:
            StrPart(self.question_parse_mode).write(payload, "question_parse_mode")
        if self.question_entities is not None:
            ListFormJsonPart(self.question_entities).write(payload, "question_entities")
        if self.is_anonymous is not None:
            BoolPart(self.is_anonymous).write(payload, "is_anonymous")
        if self.type is not None:
            StrPart(self.type).write(payload, "type")
        if self.allows_multiple_answers is not None:
            BoolPart(self.allows_multiple_answers).write(payload, "allows_multiple_answers")
        if self.allows_revoting is not None:
            BoolPart(self.allows_revoting).write(payload, "allows_revoting")
        if self.shuffle_options is not None:
            BoolPart(self.shuffle_options).write(payload, "shuffle_options")
        if self.allow_adding_options is not None:
            BoolPart(self.allow_adding_options).write(payload, "allow_adding_options")
        if self.hide_results_until_closes is not None:
            BoolPart(self.hide_results_until_closes).write(payload, "hide_results_until_closes")
        if self.members_only is not None:
            BoolPart(self.members_only).write(payload, "members_only")
        if self.country_codes is not None:
            ListPart(self.country_codes).write(payload, "country_codes")
        if self.correct_option_ids is not None:
            ListPart(self.correct_option_ids).write(payload, "correct_option_ids")
        if self.explanation is not None:
            StrPart(self.explanation).write(payload, "explanation")
        if self.explanation_parse_mode is not None:
            StrPart(self.explanation_parse_mode).write(payload, "explanation_parse_mode")
        if self.explanation_entities is not None:
            ListFormJsonPart(self.explanation_entities).write(payload, "explanation_entities")
        if self.explanation_media is not None:
            self.explanation_media.write(payload, "explanation_media")
        if self.open_period is not None:
            IntPart(self.open_period).write(payload, "open_period")
        if self.close_date is not None:
            IntPart(self.close_date).write(payload, "close_date")
        if self.is_closed is not None:
            BoolPart(self.is_closed).write(payload, "is_closed")
        if self.description is not None:
            StrPart(self.description).write(payload, "description")
        if self.description_parse_mode is not None:
            StrPart(self.description_parse_mode).write(payload, "description_parse_mode")
        if self.description_entities is not None:
            ListFormJsonPart(self.description_entities).write(payload, "description_entities")
        if self.media is not None:
            self.media.write(payload, "media")
        if self.disable_notification is not None:
            BoolPart(self.disable_notification).write(payload, "disable_notification")
        if self.protect_content is not None:
            BoolPart(self.protect_content).write(payload, "protect_content")
...
class SendChecklistMethod(BaseModel):
    ...
    async def call(self, conn: Connection) -> Message:
        ...
        StrPart(self.business_connection_id).write(payload, "business_connection_id")
        self.chat_id.write(payload, "chat_id")
        self.checklist.write(payload, "checklist")
        if self.disable_notification is not None:
            BoolPart(self.disable_notification).write(payload, "disable_notification")
        if self.protect_content is not None:
            BoolPart(self.protect_content).write(payload, "protect_content")
...
class SendDiceMethod(BaseModel):
    ...
    async def call(self, conn: Connection) -> Message:
        ...
        if self.emoji is not None:
            StrPart(self.emoji).write(payload, "emoji")
        if self.disable_notification is not None:
            BoolPart(self.disable_notification).write(payload, "disable_notification")
        if self.protect_content is not None:
            BoolPart(self.protect_content).write(payload, "protect_content")
...
class SendMessageDraftMethod(BaseModel):
    ...
    async def call(self, conn: Connection) -> bool:
        payload = MultipartPayload()
        IntPart(self.chat_id).write(payload, "chat_id")
        IntPart(self.draft_id).write(payload, "draft_id")
        if self.message_thread_id is not None:
            IntPart(self.message_thread_id).write(payload, "message_thread_id")
...
class SendChatActionMethod(BaseModel):
    ...
    async def call(self, conn: Connection) -> bool:
        payload = MultipartPayload()
        self.chat_id.write(payload, "chat_id")
        StrPart(self.action).write(payload, "action")
        if self.business_connection_id is not None:
            StrPart(self.business_connection_id).write(payload, "business_connection_id")
        if self.message_thread_id is not None:
            IntPart(self.message_thread_id).write(payload, "message_thread_id")
...
class SetMessageReactionMethod(BaseModel):
    ...
    async def call(self, conn: Connection) -> bool:
        ...
        if self.reaction is not None:
            ListFormJsonPart(self.reaction).write(payload, "reaction")
        if self.is_big is not None:
            BoolPart(self.is_big).write(payload, "is_big")
...
class GetUserProfilePhotosMethod(BaseModel):
    ...
    async def call(self, conn: Connection) -> UserProfilePhotos:
        payload = MultipartPayload()
        IntPart(self.user_id).write(payload, "user_id")
        if self.offset is not None:
            IntPart(self.offset).write(payload, "offset")
        if self.limit is not None:
            IntPart(self.limit).write(payload, "limit")
...
class SetUserEmojiStatusMethod(BaseModel):
    ...
    async def call(self, conn: Connection) -> bool:
        ...
        if self.emoji_status_custom_emoji_id is not None:
            StrPart(self.emoji_status_custom_emoji_id).write(payload, "emoji_status_custom_emoji_id")
        if self.emoji_status_expiration_date is not None:
            IntPart(self.emoji_status_expiration_date).write(payload, "emoji_status_expiration_date")
...
class GetFileMethod(BaseModel):
    ...
    async def call(self, conn: Connection) -> File:
        payload = MultipartPayload()
        StrPart(self.file_id).write(payload, "file_id")
...
class BanChatMemberMethod(BaseModel):
    ...
    async def call(self, conn: Connection) -> bool:
        ...
        if self.until_date is not None:
            IntPart(self.until_date).write(payload, "until_date")
        if self.revoke_messages is not None:
            BoolPart(self.revoke_messages).write(payload, "revoke_messages")
...
class UnbanChatMemberMethod(BaseModel):
    ...
    async def call(self, conn: Connection) -> bool:
        ...
        if self.only_if_banned is not None:
            BoolPart(self.only_if_banned).write(payload, "only_if_banned")
...
class RestrictChatMemberMethod(BaseModel):
    ...
    async def call(self, conn: Connection) -> bool:
        ...
        self.chat_id.write(payload, "chat_id")
        IntPart(self.user_id).write(payload, "user_id")
        self.permissions.write(payload, "permissions")
        if self.use_independent_chat_permissions is not None:
            BoolPart(self.use_independent_chat_permissions).write(payload, "use_independent_chat_permissions")
        if self.until_date is not None:
            IntPart(self.until_date).write(payload, "until_date")
...
class PromoteChatMemberMethod(BaseModel):
    ...
    async def call(self, conn: Connection) -> bool:
        ...
        if self.can_manage_chat is not None:
            BoolPart(self.can_manage_chat).write(payload, "can_manage_chat")
        if self.can_delete_messages is not None:
            BoolPart(self.can_delete_messages).write(payload, "can_delete_messages")
        if self.can_manage_video_chats is not None:
            BoolPart(self.can_manage_video_chats).write(payload, "can_manage_video_chats")
        if self.can_restrict_members is not None:
            BoolPart(self.can_restrict_members).write(payload, "can_restrict_members")
        if self.can_promote_members is not None:
            BoolPart(self.can_promote_members).write(payload, "can_promote_members")
        if self.can_change_info is not None:
            BoolPart(self.can_change_info).write(payload, "can_change_info")
        if self.can_invite_users is not None:
            BoolPart(self.can_invite_users).write(payload, "can_invite_users")
        if self.can_post_stories is not None:
            BoolPart(self.can_post_stories).write(payload, "can_post_stories")
        if self.can_edit_stories is not None:
            BoolPart(self.can_edit_stories).write(payload, "can_edit_stories")
        if self.can_delete_stories is not None:
            BoolPart(self.can_delete_stories).write(payload, "can_delete_stories")
        if self.can_post_messages is not None:
            BoolPart(self.can_post_messages).write(payload, "can_post_messages")
        if self.can_edit_messages is not None:
            BoolPart(self.can_edit_messages).write(payload, "can_edit_messages")
        if self.can_pin_messages is not None:
            BoolPart(self.can_pin_messages).write(payload, "can_pin_messages")
        if self.can_manage_topics is not None:
            BoolPart(self.can_manage_topics).write(payload, "can_manage_topics")
        if self.can_manage_direct_messages is not None:
            BoolPart(self.can_manage_direct_messages).write(payload, "can_manage_direct_messages")
        if self.can_manage_tags is not None:
            BoolPart(self.can_manage_tags).write(payload, "can_manage_tags")
...
class SetChatAdministratorCustomTitleMethod(BaseModel):
    ...
    async def call(self, conn: Connection) -> bool:
        ...
        self.chat_id.write(payload, "chat_id")
        IntPart(self.user_id).write(payload, "user_id")
        StrPart(self.custom_title).write(payload, "custom_title")
...
class SetChatMemberTagMethod(BaseModel):
    ...
    async def call(self, conn: Connection) -> bool:
        ...
        if self.tag is not None:
            StrPart(self.tag).write(payload, "tag")
...
class BanChatSenderChatMethod(BaseModel):
    ...
    async def call(self, conn: Connection) -> bool:
        payload = MultipartPayload()
        self.chat_id.write(payload, "chat_id")
        IntPart(self.sender_chat_id).write(payload, "sender_chat_id")
...
class CreateChatInviteLinkMethod(BaseModel):
    ...
    async def call(self, conn: Connection) -> ChatInviteLink:
        ...
        if self.name is not None:
            StrPart(self.name).write(payload, "name")
        if self.expire_date is not None:
            IntPart(self.expire_date).write(payload, "expire_date")
        if self.member_limit is not None:
            IntPart(self.member_limit).write(payload, "member_limit")
        if self.creates_join_request is not None:
            BoolPart(self.creates_join_request).write(payload, "creates_join_request")
...
class EditChatInviteLinkMethod(BaseModel):
    ...
    async def call(self, conn: Connection) -> ChatInviteLink:
        payload = MultipartPayload()
        self.chat_id.write(payload, "chat_id")
        StrPart(self.invite_link).write(payload, "invite_link")
        if self.name is not None:
            StrPart(self.name).write(payload, "name")
        if self.expire_date is not None:
            IntPart(self.expire_date).write(payload, "expire_date")
...
class CreateChatSubscriptionInviteLinkMethod(BaseModel):
    ...
    async def call(self, conn: Connection) -> ChatInviteLink:
        payload = MultipartPayload()
        self.chat_id.write(payload, "chat_id")
        IntPart(self.subscription_period).write(payload, "subscription_period")
        IntPart(self.subscription_price).write(payload, "subscription_price")
        if self.name is not None:
            StrPart(self.name).write(payload, "name")
...
class GetChatAdministratorsMethod(BaseModel):
    ...
    async def call(self, conn: Connection) -> list[ChatMember]:
        ...
        if self.return_bots is not None:
            BoolPart(self.return_bots).write(payload, "return_bots")
...
class SetChatStickerSetMethod(BaseModel):
    ...
    async def call(self, conn: Connection) -> bool:
        payload = MultipartPayload()
        self.chat_id.write(payload, "chat_id")
        StrPart(self.sticker_set_name).write(payload, "sticker_set_name")
...
class CreateForumTopicMethod(BaseModel):
    ...
    async def call(self, conn: Connection) -> ForumTopic:
        ...
        if self.icon_color is not None:
            IntPart(self.icon_color).write(payload, "icon_color")
        if self.icon_custom_emoji_id is not None:
            StrPart(self.icon_custom_emoji_id).write(payload, "icon_custom_emoji_id")
...
class AnswerCallbackQueryMethod(BaseModel):
    ...
    async def call(self, conn: Connection) -> bool:
        payload = MultipartPayload()
        StrPart(self.callback_query_id).write(payload, "callback_query_id")
        if self.text is not None:
            StrPart(self.text).write(payload, "text")
        if self.show_alert is not None:
            BoolPart(self.show_alert).write(payload, "show_alert")
        if self.url is not None:
            StrPart(self.url).write(payload, "url")
        if self.cache_time is not None:
            IntPart(self.cache_time).write(payload, "cache_time")
...
class AnswerGuestQueryMethod(BaseModel):
    ...
    async def call(self, conn: Connection) -> SentGuestMessage:
        payload = MultipartPayload()
        StrPart(self.guest_query_id).write(payload, "guest_query_id")
        self.result.write(payload, "result")
...
class SetManagedBotAccessSettingsMethod(BaseModel):
    ...
    async def call(self, conn: Connection) -> bool:
        payload = MultipartPayload()
        IntPart(self.user_id).write(payload, "user_id")
        BoolPart(self.is_access_restricted).write(payload, "is_access_restricted")
        if self.added_user_ids is not None:
            ListPart(self.added_user_ids).write(payload, "added_user_ids")
...
class SetMyCommandsMethod(BaseModel):
    ...
    async def call(self, conn: Connection) -> bool:
        payload = MultipartPayload()
        ListFormJsonPart(self.commands).write(payload, "commands")
        if self.scope is not None:
            self.scope.write(payload, "scope")
        if self.language_code is not None:
            StrPart(self.language_code).write(payload, "language_code")
...
class SetMyShortDescriptionMethod(BaseModel):
    ...
    async def call(self, conn: Connection) -> bool:
        ...
        if self.short_description is not None:
            StrPart(self.short_description).write(payload, "short_description")
        if self.language_code is not None:
            StrPart(self.language_code).write(payload, "language_code")
...
class SetChatMenuButtonMethod(BaseModel):
    ...
    async def call(self, conn: Connection) -> bool:
        ...
        if self.menu_button is not None:
            self.menu_button.write(payload, "menu_button")
...
class SetMyDefaultAdministratorRightsMethod(BaseModel):
    ...
    async def call(self, conn: Connection) -> bool:
        ...
        if self.rights is not None:
            self.rights.write(payload, "rights")
        if self.for_channels is not None:
            BoolPart(self.for_channels).write(payload, "for_channels")
...
class SendGiftMethod(BaseModel):
    ...
    async def call(self, conn: Connection) -> bool:
        payload = MultipartPayload()
        StrPart(self.gift_id).write(payload, "gift_id")
        if self.user_id is not None:
            IntPart(self.user_id).write(payload, "user_id")
        if self.chat_id is not None:
            self.chat_id.write(payload, "chat_id")
        if self.pay_for_upgrade is not None:
            BoolPart(self.pay_for_upgrade).write(payload, "pay_for_upgrade")
        if self.text is not None:
            StrPart(self.text).write(payload, "text")
        if self.text_parse_mode is not None:
            StrPart(self.text_parse_mode).write(payload, "text_parse_mode")
        if self.text_entities is not None:
            ListFormJsonPart(self.text_entities).write(payload, "text_entities")
...
class GiftPremiumSubscriptionMethod(BaseModel):
    ...
    async def call(self, conn: Connection) -> bool:
        payload = MultipartPayload()
        IntPart(self.user_id).write(payload, "user_id")
        IntPart(self.month_count).write(payload, "month_count")
        IntPart(self.star_count).write(payload, "star_count")
        if self.text is not None:
            StrPart(self.text).write(payload, "text")
        if self.text_parse_mode is not None:
...
class VerifyUserMethod(BaseModel):
    ...
    async def call(self, conn: Connection) -> bool:
        ...
        if self.custom_description is not None:
            StrPart(self.custom_description).write(payload, "custom_description")
...
class SetBusinessAccountUsernameMethod(BaseModel):
    ...
    async def call(self, conn: Connection) -> bool:
        ...
        if self.username is not None:
            StrPart(self.username).write(payload, "username")
...
class SetBusinessAccountBioMethod(BaseModel):
    ...
    async def call(self, conn: Connection) -> bool:
        ...
        if self.bio is not None:
            StrPart(self.bio).write(payload, "bio")
...
class SetBusinessAccountProfilePhotoMethod(BaseModel):
    ...
    async def call(self, conn: Connection) -> bool:
        ...
        if self.is_public is not None:
            BoolPart(self.is_public).write(payload, "is_public")
...
class SetBusinessAccountGiftSettingsMethod(BaseModel):
    ...
    async def call(self, conn: Connection) -> bool:
        payload = MultipartPayload()
        StrPart(self.business_connection_id).write(payload, "business_connection_id")
        BoolPart(self.show_gift_button).write(payload, "show_gift_button")
        self.accepted_gift_types.write(payload, "accepted_gift_types")
...
class GetBusinessAccountGiftsMethod(BaseModel):
    ...
    async def call(self, conn: Connection) -> OwnedGifts:
        ...
        if self.exclude_unsaved is not None:
            BoolPart(self.exclude_unsaved).write(payload, "exclude_unsaved")
        if self.exclude_saved is not None:
            BoolPart(self.exclude_saved).write(payload, "exclude_saved")
        if self.exclude_unlimited is not None:
            BoolPart(self.exclude_unlimited).write(payload, "exclude_unlimited")
        if self.exclude_limited_upgradable is not None:
            BoolPart(self.exclude_limited_upgradable).write(payload, "exclude_limited_upgradable")
        if self.exclude_limited_non_upgradable is not None:
            BoolPart(self.exclude_limited_non_upgradable).write(payload, "exclude_limited_non_upgradable")
        if self.exclude_unique is not None:
            BoolPart(self.exclude_unique).write(payload, "exclude_unique")
        if self.exclude_from_blockchain is not None:
            BoolPart(self.exclude_from_blockchain).write(payload, "exclude_from_blockchain")
        if self.sort_by_price is not None:
            BoolPart(self.sort_by_price).write(payload, "sort_by_price")
        if self.offset is not None:
            StrPart(self.offset).write(payload, "offset")
        if self.limit is not None:
            IntPart(self.limit).write(payload, "limit")
...
class ConvertGiftToStarsMethod(BaseModel):
    ...
    async def call(self, conn: Connection) -> bool:
        payload = MultipartPayload()
        StrPart(self.business_connection_id).write(payload, "business_connection_id")
        StrPart(self.owned_gift_id).write(payload, "owned_gift_id")
...
class UpgradeGiftMethod(BaseModel):
    ...
    async def call(self, conn: Connection) -> bool:
        ...
        if self.keep_original_details is not None:
            BoolPart(self.keep_original_details).write(payload, "keep_original_details")
...
class TransferGiftMethod(BaseModel):
    ...
    async def call(self, conn: Connection) -> bool:
        ...
        StrPart(self.business_connection_id).write(payload, "business_connection_id")
        StrPart(self.owned_gift_id).write(payload, "owned_gift_id")
        IntPart(self.new_owner_chat_id).write(payload, "new_owner_chat_id")
        if self.star_count is not None:
            IntPart(self.star_count).write(payload, "star_count")
...
class PostStoryMethod(BaseModel):
    ...
    async def call(self, conn: Connection) -> Story:
        payload = MultipartPayload()
        StrPart(self.business_connection_id).write(payload, "business_connection_id")
        self.content.write(payload, "content")
        IntPart(self.active_period).write(payload, "active_period")
        if self.caption is not None:
            StrPart(self.caption).write(payload, "caption")
        if self.parse_mode is not None:
            StrPart(self.parse_mode).write(payload, "parse_mode")
        ...
        if self.areas is not None:
            ListFormJsonPart(self.areas).write(payload, "areas")
        if self.post_to_chat_page is not None:
            BoolPart(self.post_to_chat_page).write(payload, "post_to_chat_page")
        if self.protect_content is not None:
            BoolPart(self.protect_content).write(payload, "protect_content")
...
class RepostStoryMethod(BaseModel):
    ...
    async def call(self, conn: Connection) -> Story:
        payload = MultipartPayload()
        StrPart(self.business_connection_id).write(payload, "business_connection_id")
        IntPart(self.from_chat_id).write(payload, "from_chat_id")
        IntPart(self.from_story_id).write(payload, "from_story_id")
        IntPart(self.active_period).write(payload, "active_period")
        if self.post_to_chat_page is not None:
            BoolPart(self.post_to_chat_page).write(payload, "post_to_chat_page")
        if self.protect_content is not None:
...
class EditStoryMethod(BaseModel):
    ...
    async def call(self, conn: Connection) -> Story:
        payload = MultipartPayload()
        StrPart(self.business_connection_id).write(payload, "business_connection_id")
        IntPart(self.story_id).write(payload, "story_id")
        self.content.write(payload, "content")
        if self.caption is not None:
            StrPart(self.caption).write(payload, "caption")
        if self.parse_mode is not None:
...
class AnswerWebAppQueryMethod(BaseModel):
    ...
    async def call(self, conn: Connection) -> SentWebAppMessage:
        payload = MultipartPayload()
        StrPart(self.web_app_query_id).write(payload, "web_app_query_id")
        self.result.write(payload, "result")
...
class SavePreparedInlineMessageMethod(BaseModel):
    ...
    async def call(self, conn: Connection) -> PreparedInlineMessage:
        ...
        if self.allow_user_chats is not None:
            BoolPart(self.allow_user_chats).write(payload, "allow_user_chats")
        if self.allow_bot_chats is not None:
            BoolPart(self.allow_bot_chats).write(payload, "allow_bot_chats")
        if self.allow_group_chats is not None:
            BoolPart(self.allow_group_chats).write(payload, "allow_group_chats")
        if self.allow_channel_chats is not None:
            BoolPart(self.allow_channel_chats).write(payload, "allow_channel_chats")
...
class SavePreparedKeyboardButtonMethod(BaseModel):
    ...
    async def call(self, conn: Connection) -> PreparedKeyboardButton:
        payload = MultipartPayload()
        IntPart(self.user_id).write(payload, "user_id")
        self.button.write(payload, "button")
...
class EditMessageTextMethod(BaseModel):
    ...
    async def call(self, conn: Connection) -> MaybeMessage:
        ...
        if self.inline_message_id is not None:
            StrPart(self.inline_message_id).write(payload, "inline_message_id")
        if self.parse_mode is not None:
            StrPart(self.parse_mode).write(payload, "parse_mode")
        if self.entities is not None:
            ListFormJsonPart(self.entities).write(payload, "entities")
...
class ApproveSuggestedPostMethod(BaseModel):
    ...
    async def call(self, conn: Connection) -> bool:
        ...
        if self.send_date is not None:
            IntPart(self.send_date).write(payload, "send_date")
...
class DeclineSuggestedPostMethod(BaseModel):
    ...
    async def call(self, conn: Connection) -> bool:
        ...
        if self.comment is not None:
            StrPart(self.comment).write(payload, "comment")
...
class DeleteMessageReactionMethod(BaseModel):
    ...
    async def call(self, conn: Connection) -> bool:
        ...
        if self.actor_chat_id is not None:
            IntPart(self.actor_chat_id).write(payload, "actor_chat_id")
...
class SendStickerMethod(BaseModel):
    ...
    async def call(self, conn: Connection) -> Message:
        payload = MultipartPayload()
        self.chat_id.write(payload, "chat_id")
        self.sticker.write(payload, "sticker")
        if self.business_connection_id is not None:
            StrPart(self.business_connection_id).write(payload, "business_connection_id")
        if self.message_thread_id is not None:
            IntPart(self.message_thread_id).write(payload, "message_thread_id")
...
class GetCustomEmojiStickersMethod(BaseModel):
    ...
    async def call(self, conn: Connection) -> list[Sticker]:
        payload = MultipartPayload()
        ListPart(self.custom_emoji_ids).write(payload, "custom_emoji_ids")
...
class UploadStickerFileMethod(BaseModel):
    ...
    async def call(self, conn: Connection) -> File:
        ...
        IntPart(self.user_id).write(payload, "user_id")
        self.sticker.write(payload, "sticker")
        StrPart(self.sticker_format).write(payload, "sticker_format")
...
class CreateNewStickerSetMethod(BaseModel):
    ...
    async def call(self, conn: Connection) -> bool:
        ...
        StrPart(self.name).write(payload, "name")
        StrPart(self.title).write(payload, "title")
        ListFormJsonPart(self.stickers).write(payload, "stickers")
        if self.sticker_type is not None:
            StrPart(self.sticker_type).write(payload, "sticker_type")
        if self.needs_repainting is not None:
            BoolPart(self.needs_repainting).write(payload, "needs_repainting")
...
class SetStickerPositionInSetMethod(BaseModel):
    ...
    async def call(self, conn: Connection) -> bool:
        payload = MultipartPayload()
        StrPart(self.sticker).write(payload, "sticker")
        IntPart(self.position).write(payload, "position")
...
class ReplaceStickerInSetMethod(BaseModel):
    ...
    async def call(self, conn: Connection) -> bool:
        ...
        IntPart(self.user_id).write(payload, "user_id")
        StrPart(self.name).write(payload, "name")
        StrPart(self.old_sticker).write(payload, "old_sticker")
        self.sticker.write(payload, "sticker")
...
class SetStickerEmojiListMethod(BaseModel):
    ...
    async def call(self, conn: Connection) -> bool:
        payload = MultipartPayload()
        StrPart(self.sticker).write(payload, "sticker")
        ListPart(self.emoji_list).write(payload, "emoji_list")
...
class SetStickerKeywordsMethod(BaseModel):
    ...
    async def call(self, conn: Connection) -> bool:
        ...
        if self.keywords is not None:
            ListPart(self.keywords).write(payload, "keywords")
...
class SetStickerMaskPositionMethod(BaseModel):
    ...
    async def call(self, conn: Connection) -> bool:
        ...
        if self.mask_position is not None:
            self.mask_position.write(payload, "mask_position")
...
class SetStickerSetThumbnailMethod(BaseModel):
    ...
    async def call(self, conn: Connection) -> bool:
        ...
        StrPart(self.name).write(payload, "name")
        IntPart(self.user_id).write(payload, "user_id")
        StrPart(self.format).write(payload, "format")
        if self.thumbnail is not None:
            self.thumbnail.write(payload, "thumbnail")
...
class SetCustomEmojiStickerSetThumbnailMethod(BaseModel):
    ...
    async def call(self, conn: Connection) -> bool:
        ...
        if self.custom_emoji_id is not None:
            StrPart(self.custom_emoji_id).write(payload, "custom_emoji_id")
...
class AnswerInlineQueryMethod(BaseModel):
    ...
    async def call(self, conn: Connection) -> bool:
        payload = MultipartPayload()
        StrPart(self.inline_query_id).write(payload, "inline_query_id")
        ListFormJsonPart(self.results).write(payload, "results")
        if self.cache_time is not None:
            IntPart(self.cache_time).write(payload, "cache_time")
        if self.is_personal is not None:
            BoolPart(self.is_personal).write(payload, "is_personal")
        if self.next_offset is not None:
            StrPart(self.next_offset).write(payload, "next_offset")
...
class SendInvoiceMethod(BaseModel):
    ...
    async def call(self, conn: Connection) -> Message:
        ...
        StrPart(self.description).write(payload, "description")
        StrPart(self.payload).write(payload, "payload")
        StrPart(self.currency).write(payload, "currency")
        ListFormJsonPart(self.prices).write(payload, "prices")
        if self.message_thread_id is not None:
            IntPart(self.message_thread_id).write(payload, "message_thread_id")
        if self.direct_messages_topic_id is not None:
            IntPart(self.direct_messages_topic_id).write(payload, "direct_messages_topic_id")
        if self.provider_token is not None:
            StrPart(self.provider_token).write(payload, "provider_token")
        if self.max_tip_amount is not None:
            IntPart(self.max_tip_amount).write(payload, "max_tip_amount")
        if self.suggested_tip_amounts is not None:
            ListPart(self.suggested_tip_amounts).write(payload, "suggested_tip_amounts")
        if self.start_parameter is not None:
            StrPart(self.start_parameter).write(payload, "start_parameter")
        if self.provider_data is not None:
            StrPart(self.provider_data).write(payload, "provider_data")
        if self.photo_url is not None:
            StrPart(self.photo_url).write(payload, "photo_url")
        if self.photo_size is not None:
            IntPart(self.photo_size).write(payload, "photo_size")
        if self.photo_width is not None:
            IntPart(self.photo_width).write(payload, "photo_width")
        if self.photo_height is not None:
            IntPart(self.photo_height).write(payload, "photo_height")
        if self.need_name is not None:
            BoolPart(self.need_name).write(payload, "need_name")
        if self.need_phone_number is not None:
            BoolPart(self.need_phone_number).write(payload, "need_phone_number")
        if self.need_email is not None:
            BoolPart(self.need_email).write(payload, "need_email")
        if self.need_shipping_address is not None:
            BoolPart(self.need_shipping_address).write(payload, "need_shipping_address")
        if self.send_phone_number_to_provider is not None:
            BoolPart(self.send_phone_number_to_provider).write(payload, "send_phone_number_to_provider")
        if self.send_email_to_provider is not None:
            BoolPart(self.send_email_to_provider).write(payload, "send_email_to_provider")
        if self.is_flexible is not None:
            BoolPart(self.is_flexible).write(payload, "is_flexible")
        if self.disable_notification is not None:
            BoolPart(self.disable_notification).write(payload, "disable_notification")
        if self.protect_content is not None:
            BoolPart(self.protect_content).write(payload, "protect_content")
...
class AnswerShippingQueryMethod(BaseModel):
    ...
    async def call(self, conn: Connection) -> bool:
        payload = MultipartPayload()
        StrPart(self.shipping_query_id).write(payload, "shipping_query_id")
        BoolPart(self.ok).write(payload, "ok")
        if self.shipping_options is not None:
            ListFormJsonPart(self.shipping_options).write(payload, "shipping_options")
        if self.error_message is not None:
            StrPart(self.error_message).write(payload, "error_message")
...
class AnswerPreCheckoutQueryMethod(BaseModel):
    ...
    async def call(self, conn: Connection) -> bool:
        payload = MultipartPayload()
        StrPart(self.pre_checkout_query_id).write(payload, "pre_checkout_query_id")
        BoolPart(self.ok).write(payload, "ok")
        if self.error_message is not None:
            StrPart(self.error_message).write(payload, "error_message")
...
class RefundStarPaymentMethod(BaseModel):
    ...
    async def call(self, conn: Connection) -> bool:
        payload = MultipartPayload()
        IntPart(self.user_id).write(payload, "user_id")
        StrPart(self.telegram_payment_charge_id).write(payload, "telegram_payment_charge_id")
...
class EditUserStarSubscriptionMethod(BaseModel):
    ...
    async def call(self, conn: Connection) -> bool:
        ...
        IntPart(self.user_id).write(payload, "user_id")
        StrPart(self.telegram_payment_charge_id).write(payload, "telegram_payment_charge_id")
        BoolPart(self.is_canceled).write(payload, "is_canceled")
...
class SetPassportDataErrorsMethod(BaseModel):
    ...
    async def call(self, conn: Connection) -> bool:
        payload = MultipartPayload()
        IntPart(self.user_id).write(payload, "user_id")
        ListFormJsonPart(self.errors).write(payload, "errors")
...
class SendGameMethod(BaseModel):
    ...
    async def call(self, conn: Connection) -> Message:
        payload = MultipartPayload()
        self.chat_id.write(payload, "chat_id")
        StrPart(self.game_short_name).write(payload, "game_short_name")
        if self.business_connection_id is not None:
            StrPart(self.business_connection_id).write(payload, "business_connection_id")
        if self.message_thread_id is not None:
            IntPart(self.message_thread_id).write(payload, "message_thread_id")
...
class SetGameScoreMethod(BaseModel):
    ...
    async def call(self, conn: Connection) -> MaybeMessage:
        payload = MultipartPayload()
        IntPart(self.user_id).write(payload, "user_id")
        IntPart(self.score).write(payload, "score")
        if self.force is not None:
            BoolPart(self.force).write(payload, "force")
        if self.disable_edit_message is not None:
            BoolPart(self.disable_edit_message).write(payload, "disable_edit_message")
        if self.chat_id is not None:
            IntPart(self.chat_id).write(payload, "chat_id")
        if self.message_id is not None:
            IntPart(self.message_id).write(payload, "message_id")
