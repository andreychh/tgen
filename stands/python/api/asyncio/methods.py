...
class SendMessageMethod(BaseModel):
    ...
    async def call(self, conn: Connection) -> Message:
        ...
        if self.receiver_user_id is not None:
            _IntPart(self.receiver_user_id)._write(payload, "receiver_user_id")
...
class CopyMessageMethod(BaseModel):
    ...
    value of the field correct_option_ids is known to the bot. The method is
...
class AnswerChatJoinRequestQueryMethod(BaseModel):
    ...
    async def call(self, conn: Connection) -> bool:
        payload = _MultipartPayload()
        _StrPart(self.chat_join_request_query_id)._write(payload, "chat_join_request_query_id")
        _StrPart(self.result)._write(payload, "result")
        return await conn.do(Method.AnswerChatJoinRequestQuery, payload, TypeAdapter(bool)) 

 
class SendChatJoinRequestWebAppMethod(BaseModel):
    """
    Use this method to process a received chat join request query by showing
    a Mini App to the user before deciding the outcome. Call
    answerChatJoinRequestQuery to resolve the join request query based on
    ...
    async def call(self, conn: Connection) -> bool:
        payload = _MultipartPayload()
        _StrPart(self.chat_join_request_query_id)._write(payload, "chat_join_request_query_id")
        _StrPart(self.web_app_url)._write(payload, "web_app_url")
        return await conn.do(Method.SendChatJoinRequestWebApp, payload, TypeAdapter(bool)) 
...
class EditMessageTextMethod(BaseModel):
    ...
    async def call(self, conn: Connection) -> MaybeMessage:
        ...
        if self.rich_message is not None:
            self.rich_message._write(payload, "rich_message")
        if self.reply_markup is not None:
            self.reply_markup._write(payload, "reply_markup")
...
class EditMessageMediaMethod(BaseModel):
    ...
    or video messages, or to replace a text or a rich message with a media.
    ...
    a photo, a live photo, or a video otherwise. When an inline message is
    ...
    an inline message, the edited Message is returned, otherwise True is
...
class EditEphemeralMessageTextMethod(BaseModel):
    ...
    async def call(self, conn: Connection) -> bool:
        ...
        self.chat_id._write(payload, "chat_id")
        _IntPart(self.receiver_user_id)._write(payload, "receiver_user_id")
        _IntPart(self.ephemeral_message_id)._write(payload, "ephemeral_message_id")
        _StrPart(self.text)._write(payload, "text")
        if self.parse_mode is not None:
            _StrPart(self.parse_mode)._write(payload, "parse_mode")
        if self.entities is not None:
        ...
        if self.reply_markup is not None:
            self.reply_markup._write(payload, "reply_markup")
        return await conn.do(Method.EditEphemeralMessageText, payload, TypeAdapter(bool)) 

 
class EditEphemeralMessageMediaMethod(BaseModel):
    """
    Use this method to edit the media of an ephemeral message. Note that it
    ...
    async def call(self, conn: Connection) -> bool:
        ...
        if self.reply_markup is not None:
            self.reply_markup._write(payload, "reply_markup")
        return await conn.do(Method.EditEphemeralMessageMedia, payload, TypeAdapter(bool)) 

 
class EditEphemeralMessageCaptionMethod(BaseModel):
    """
    Use this method to edit the caption of an ephemeral message. Note that
    ...
    async def call(self, conn: Connection) -> bool:
        ...
        if self.reply_markup is not None:
            self.reply_markup._write(payload, "reply_markup")
        return await conn.do(Method.EditEphemeralMessageCaption, payload, TypeAdapter(bool)) 
...
class EditEphemeralMessageReplyMarkupMethod(BaseModel):
    ...
    async def call(self, conn: Connection) -> bool:
        ...
        if self.reply_markup is not None:
            self.reply_markup._write(payload, "reply_markup")
        return await conn.do(Method.EditEphemeralMessageReplyMarkup, payload, TypeAdapter(bool)) 
...
class DeleteEphemeralMessageMethod(BaseModel):
    ...
    async def call(self, conn: Connection) -> bool:
        ...
        _IntPart(self.receiver_user_id)._write(payload, "receiver_user_id")
        _IntPart(self.ephemeral_message_id)._write(payload, "ephemeral_message_id")
        return await conn.do(Method.DeleteEphemeralMessage, payload, TypeAdapter(bool)) 
...
class SendRichMessageMethod(BaseModel):
    """
    Use this method to send rich messages. If the message contains a block
    with a media element, then the bot must have the right to send the media
    to the chat. On success, the sent Message is returned.
    ...
    async def call(self, conn: Connection) -> Message:
        ...
        if self.reply_markup is not None:
            self.reply_markup._write(payload, "reply_markup")
        return await conn.do(Method.SendRichMessage, payload, TypeAdapter(Message)) 

 
class SendRichMessageDraftMethod(BaseModel):
    """
    Use this method to stream a partial rich message to a user while the
    message is being generated. Note that the streamed draft is ephemeral
    and acts as a temporary 30-second preview - once the output is
    finalized, you must call sendRichMessage with the complete message to
    ...
    async def call(self, conn: Connection) -> bool:
        ...
        if self.message_thread_id is not None:
            _IntPart(self.message_thread_id)._write(payload, "message_thread_id")
        return await conn.do(Method.SendRichMessageDraft, payload, TypeAdapter(bool)) 
