...
// 	tgen    (devel)
// 	Bot API 10.3
// changelog: https://core.telegram.org/bots/api-changelog#august-24-2026
...
type LoginURL struct {
	...
	// be the same as the domain linked with the bot. See Linking your domain to the
...
type SendMessageDraftMethod struct {
	...
	// will still disappear after a short time or if the bot sends a message. To
	// fully preserve the partial draft, the bot should send it as a new message.
...
func (m EditEphemeralMessageTextMethod) payload() (formPayload, error) {
	sink := newFileSink()
	var richMessage json.RawMessage
	if m.RichMessage != nil {
		data, err := m.RichMessage.resolve(sink)
	...
	type alias EditEphemeralMessageTextMethod
	return newFormPayload(struct {
		RichMessage json.RawMessage `json:"rich_message,omitempty"`
		alias
	}{
...
func (o *RichMessageButton) UnmarshalJSON(data []byte) error {
...
func (RichTextButton) sealedRichText() {}
...
func (o RichTextButton) MarshalJSON() ([]byte, error) {
...
func (RichBlockExpandableBlockQuotation) sealedRichBlock() {}
...
func (RichBlockButtons) sealedRichBlock() {}
func (RichBlockAnimation) sealedRichBlock() {}
func (RichBlockAudio) sealedRichBlock() {}
func (RichBlockDocument) sealedRichBlock() {}
...
func unmarshalRichBlock(data []byte) (RichBlock, error) {
	...
	case "expandable_blockquote":
		var variant RichBlockExpandableBlockQuotation
		if err := json.Unmarshal(data, &variant); err != nil {
			return nil, err
		}
		return variant, nil
...
func (o *RichBlockExpandableBlockQuotation) UnmarshalJSON(data []byte) error {
	...
	*o = RichBlockExpandableBlockQuotation(aux.alias)
	if aux.Text != nil {
		result, err := unmarshalRichText(aux.Text)
		if err != nil {
			return err
...
// A block containing a list of buttons that are shown in one row, corresponding
...
func (InputRichBlockExpandableBlockQuotation) sealedInputRichBlock() {}
...
func (InputRichBlockButtons) sealedInputRichBlock() {}
func (InputRichBlockAnimation) sealedInputRichBlock() {}
func (InputRichBlockAudio) sealedInputRichBlock() {}
func (InputRichBlockDocument) sealedInputRichBlock() {}
...
func (o InputRichBlockExpandableBlockQuotation) MarshalJSON() ([]byte, error) {
...
func (o InputRichBlockExpandableBlockQuotation) resolve(_ *fileSink) (json.RawMessage, error) {
	return json.Marshal(o)
}
...
func (o InputRichBlockButtons) MarshalJSON() ([]byte, error) {
...
func (o InputRichBlockButtons) resolve(_ *fileSink) (json.RawMessage, error) {
	return json.Marshal(o)
}
...
func (o InputRichBlockDocument) MarshalJSON() ([]byte, error) {
...
func (o InputRichBlockDocument) resolve(sink *fileSink) (json.RawMessage, error) {
	document, err := o.Document.resolve(sink)
	if err != nil {
		return nil, err
	}
	type alias InputRichBlockDocument
...
func (InputMediaDocument) sealedInputRichMedia() {}
