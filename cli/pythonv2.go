...
func pythonV2Action(cmd *cobra.Command, _ []string, m meta.Meta) error {
	...
	artifacts, err := pythonv2.NewPass(
		pythonv2.NewGeneration(
			pythonv2.NewSpecification(ir.NewSpecification(spec)),
